...
export default function RecipientDashboard() {
  ...
  useEffect(() => {
    if (!authLoading && (!user || user.role !== 'RECIPIENT')) {
        ...
        setNearbyDonations([
          {
            ...
            description: 'Fresh organic vegetables including carrots, spinach, and tomatoes',
            category: 'VEGETABLES',
            quantity: 5,
            unit: 'kg',
          ...
          },
          {
            ...
            description: 'Delicious homemade vegetable soup with fresh bread',
  ...
  const handleReserveDonation = async (donationId: string) => {
    alert(`Reservation for donation ${donationId} will be implemented soon!`)
  }
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border">
            ...
            <div className="h-80 flex items-center justify-center bg-gray-100">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">Showing donations within 5km radius</p>
              </div>
            </div>
          </div>
